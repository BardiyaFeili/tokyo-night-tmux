...
#+--- Bars LEFT ---+
# Session name
tmux set -g status-left "#[fg=${THEME[blue]},bg=default,bold] #{?client_prefix,󰠠 ,#[dim]󰤂 }#[bold,nodim]#S$hostname  "
...
# Unfocused
tmux set -g window-status-format "$RESET#[fg=${THEME[foreground]}] #{?#{==:#{pane_current_command},ssh},󰣀 ,  }${RESET}$window_number#W#[nobold,dim]#{?window_zoomed_flag, $zoom_number, $custom_pane}#[fg=${THEME[purple]}]#{?window_last_flag,󰁯  , }"
